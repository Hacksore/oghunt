...
export default function PostList({
  ...
  return (
    <div className="flex flex-col items-center">
      ...
      <button
        className="bg-gradient-to-br from-emerald-400 to-emerald-600 text-white px-6 py-3 rounded-full font-semibold text-xl mt-8 duration-300 hover:-translate-y-1 active:translate-y-0 active:duration-75 active:brightness-75"
