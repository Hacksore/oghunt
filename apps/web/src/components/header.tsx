    ...
    <header className="w-full">
      <div className="max-w-4xl container mx-auto px-4 py-4 flex justify-between">
        ...
        <div className="flex gap-4 items-center">
          <Link
            href="/homies"
            className="opacity-50 hover:opacity-100 duration-300 group mr-2 max-sm:hidden"
          >
            <span className="group-hover:opacity-100 opacity-0 duration-300">/</span>homies
          </Link>
          <ThemeButton />
          <Link
          ...
          >
            <svg
              className="size-5 fill-current group-hover:rotate-360 group-hover:scale-125 duration-500 ease-[cubic-bezier(0.175,0.885,0.32,1.275)] group-active:duration-75 group-active:scale-95"
              role="img"
              viewBox="0 0 24 24"
